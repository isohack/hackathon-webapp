...
render() {
  ...
  <div id="modal2" className="modal bottom-sheet">
    <div className="modal-content">
      <h4 className="header center">25/12/2019 to 31/1/2020</h4>
      <h5 className="center">Registration and Submission of ideas</h5>
  ...
  <div id="modal3" className="modal bottom-sheet">
    <div className="modal-content">
      <h4 className="header center">8/1/2020</h4>
